/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e06f940a13d9792655dd45f691b71401)
// Runtime types generated with workerd@1.20250617.0 2025-07-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DAYTONA_API_KEY: string;
		ANTHROPIC_API_KEY: string;
		SANDBOX_MANAGER: DurableObjectNamespace /* SandboxManager from nightona */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DAYTONA_API_KEY" | "ANTHROPIC_API_KEY">> {}
}
